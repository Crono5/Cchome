<div class="span6">
			<div class="row widgetBloqueHome" id="unete">
				...
				<script>(function(d, s, id) {
				  ...
				  js.src = "//connect.facebook.net/en_US/all.js#xfbml=1&appId=236804413021755";
				  fjs.parentNode.insertBefore(js, fjs);
				}(document, 'script', 'facebook-jssdk'));</script>
				<div class="fb-like" data-href="http://colombiacaliente.net" data-send="false" data-width="280" data-show-faces="true" data-font="segoe ui"></div>
...
<!-- <div class="span2"><a class="btn" href="#">Hola</a></div> -->
				...
				<img src="_/img/ads/ads160x230cc.png"> 
				</div>
			</div> 
